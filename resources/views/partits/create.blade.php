...
<div class="container">
    ...
    <form action="{{ route('partits.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="mb-4">
            ...
            <select name="local_id" id="local_id" class="w-full border rounded p-2 @error('local_id') border-red-500 @enderror">
        ...
        <div class="mb-4">
            ...
            <select name="visitant_id" id="visitant_id" class="w-full border rounded p-2 @error('visitant_id') border-red-500 @enderror">
                <option value="">Selecciona un equipo</option>
                @foreach($equips as $equip)
        ...
        <div class="mb-4">
            ...
            <input type="date" name="data" id="data" value="{{ old('data') }}" class="w-full border rounded p-2 @error('data') border-red-500 @enderror">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="jornada" id="jornada" value="{{ old('jornada') }}" class="w-full border rounded p-2 @error('jornada') border-red-500 @enderror">
        ...
        <div class="mb-4">
            ...
            <select name="estadi_id" id="estadi_id" class="w-full border rounded p-2 @error('estadi_id') border-red-500 @enderror">
        ...
        <!-- Botón -->
        <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Crear Partido</button>
